...
<article class="page-container">
	...
	<form  action="{{url('admin/lAdd')}}" method="post" id="myForm" class="form form-horizontal">
		@csrf
		<div class="row cl" >
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>
                友情链接名称：</label>
			<div class="formControls col-xs-8 col-sm-9" style="width: 30%">
                <input type="text" id="link_name" class="input-text" value="" placeholder="请输入友情链接名称" name="link_name">
            </div>
		</div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">友情链接标题：</label>
            <div class="formControls col-xs-8 col-sm-9" style="width: 30%">
                <input type="text" id="link_title" class="input-text" value="" placeholder="请输入友情链接标题" name="link_title">
            </div>
        </div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">排序值：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="0" placeholder="" name="link_sort" style="width: 20%" />
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			<div class="col-xs-12 col-sm-12 col-xs-offset-4 col-sm-offset-2">
                <input type="submit" class="btn btn-primary btn-group-lg radius" value="添加友情链接">
			</div>
		</div>
	</form>
</article>
