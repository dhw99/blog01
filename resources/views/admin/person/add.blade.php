...
<abouticle class="page-container">
	...
	<form  action="{{url('admin/aboutAdd')}}" method="post" id="myForm" class="form form-horizontal">
		@csrf
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9" style="width: 30%">
                <input type="text" id="about_author" class="input-text" value="" placeholder="请输入作者名字" name="about_author">
            </div>
        </div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">职业：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="" name="about_job" style="width: 50%" />
			</div>
		</div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">微信号：</label>
            <div class="formControls col-xs-8 col-sm-9" style="width: 30%">
                <input type="text" id="about_weixin" class="input-text" value="" placeholder="请输入微信号" name="about_weixin">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">电子邮箱：</label>
            <div class="formControls col-xs-8 col-sm-9" style="width: 30%">
                <input type="text" id="about_email" class="input-text" value="" placeholder="请输入电子邮箱" name="about_email">
            </div>
        </div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">关键词：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="keywords" name="about_key">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">个人介绍描述：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="about_des" cols="" rows="" class="textarea"></textarea>
			</div>
		</div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                <input type="text" size="50" name="about_pic" value="">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">头像展示：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <img src="" id="about_img" class="img-circle" alt="">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">添加个人介绍：</label>
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                <!-- 加载编辑器的容器 -->
                <script id="container" name="about_content" type="text/plain"></script>
		...
		<div class="row cl">
			<div class="col-xs-12 col-sm-12 col-xs-offset-4 col-sm-offset-2">
                <input type="submit" class="btn btn-primary btn-group-lg radius" value="添加个人介绍">
			</div>
		</div>
	</form>
</abouticle>
